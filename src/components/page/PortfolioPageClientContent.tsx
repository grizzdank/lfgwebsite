...
function DeviceMockup({ src, alt, url }: { src: string; alt: string; url?: string }) {
  const content = (
  ...
  if (url) {
    return (
      <a href={url} target="_blank" rel="noopener noreferrer" className="block hover:scale-[1.02] transition-transform duration-500">
        {content}
      </a>
    );
  }
...
function CapabilityIcon({ name }: { name: string }) {
  const icons: Record<string, JSX.Element> = {
    ...
    rocket: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.09 14.09 0 006.16-12.12A14.09 14.09 0 009.63 2.23a6 6 0 015.96 12.14zm-5.84 2.56L4.5 21.75m5.25-5.82v4.82a6 6 0 01-5.84-7.38l5.84 2.56z" />
      </svg>
    ),
    cpu: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              From complete website transformations to AI-powered SaaS platforms,
              here&apos;s a look at how we help organizations achieve their digital goals.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#1a2e23] mb-4" style={{ fontFamily: 'Georgia, serif' }}>
                {pearlywrites.title}
              </h2>
              <p className="text-xl text-[#c17f59] font-medium mb-6">{pearlywrites.subtitle}</p>
              ...
              <div className="space-y-6 mb-8">
                <div>
                  <h4 className="font-semibold text-[#1a2e23] mb-2">The Challenge</h4>
                  <p className="text-[#4a5d52]">{pearlywrites.challenge}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#1a2e23] mb-2">Our Solution</h4>
                ...
                <ul className="space-y-3">
                  {pearlywrites.results.map((result, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-[#2c4a3c] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            >
              ...
              <div className="flex justify-between mt-4 text-sm">
                <span className="text-[#6b7c72]"><span className="font-semibold text-[#1a2e23]">Before:</span> WordPress (2024)</span>
                <span className="text-[#6b7c72]"><span className="font-semibold text-[#2c4a3c]">After:</span> Next.js (2025)</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-xl text-[#c17f59] font-medium mb-6">{lfg.subtitle}</p>
              <p className="text-lg text-[#4a5d52] leading-relaxed mb-8">
                {lfg.description}
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {lfg.results.map((result, i) => (
                  <div key={i} className="bg-white rounded-xl p-4 shadow-sm border border-[#e8eeeb]">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xl text-[#c17f59] font-medium mb-6">{contractflo.subtitle}</p>
              ...
              <div className="relative">
                ...
                <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <p className="font-semibold text-[#1a2e23]">ContractFlo</p>
                      <p className="text-sm text-[#6b7c72]">Contract Management</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-[#f3f7f5] rounded-lg">
                      <span className="text-sm text-[#4a5d52]">Active Contracts</span>
                      <span className="font-semibold text-[#2c4a3c]">247</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-[#f3f7f5] rounded-lg">
                      <span className="text-sm text-[#4a5d52]">Pending Review</span>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#1a2e23]" style={{ fontFamily: 'Georgia, serif' }}>
              Our Capabilities
            </h2>
            <p className="mt-4 text-lg text-[#4a5d52] max-w-2xl mx-auto">
              Beyond these featured projects, here&apos;s the full range of what we bring to the table.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-[#f3f7f5]">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#1a2e23] mb-6" style={{ fontFamily: 'Georgia, serif' }}>
              Let&apos;s build something
              <br />
              <span className="text-[#2c4a3c]">remarkable together</span>
            </h2>
            <p className="text-xl text-[#4a5d52] mb-10 max-w-2xl mx-auto">
              Whether you need a website refresh, an MVP to validate your idea, or AI integration
              to transform your workflows—we&apos;re ready to help.
            </p>
